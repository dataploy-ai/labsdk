module github.com/raptor-ml/labsdk
...
require (
	...
	github.com/raptor-ml/raptor v0.0.0-20220720132843-de21f761c700
)
...
require (
	...
	k8s.io/apiextensions-apiserver v0.25.0-alpha.3 // indirect
	k8s.io/apimachinery v0.25.0-alpha.3 // indirect
	k8s.io/client-go v0.25.0-alpha.3 // indirect
