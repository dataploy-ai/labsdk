...
# gopy pkg -output=example -vm=python3 github.com/raptor-ml/natun/pkg/pyexp
...
ifeq (, $(shell which gopy))
	...
	go install github.com/raptor-ml/natun/pkg/gopy@master
endif
...
local-build: _verfiy-deps ## Build the PyExp extension for local development purposes
	gopy build --name="pyexp" --output natun/pyexp --vm=$(PYTHON) github.com/raptor-ml/natun/pkg/pyexp
