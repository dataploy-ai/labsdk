# python build stubs for package pyexp
...
mod.add_function('Slice_pyexp_Instruction_CTor', retval('int64_t'), [])
mod.add_function('Slice_pyexp_Instruction_len', retval('int'), [param('int64_t', 'handle')])
mod.add_function('Slice_pyexp_Instruction_elem', retval('int64_t'), [param('int64_t', 'handle'), param('int', 'idx')])
mod.add_function('Slice_pyexp_Instruction_subslice', retval('int64_t'), [param('int64_t', 'handle'), param('int', 'st'), param('int', 'ed')])
mod.add_function('Slice_pyexp_Instruction_set', None, [param('int64_t', 'handle'), param('int', 'idx'), param('int64_t', 'value')])
mod.add_function('Slice_pyexp_Instruction_append', None, [param('int64_t', 'handle'), param('int64_t', 'value')])
...
add_checked_function(mod, 'pyexp_Runtime_DiscoverDependencies', retval('int64_t'), [param('int64_t', '_handle')])
add_checked_function(mod, 'pyexp_Runtime_Exec', retval('int64_t'), [param('int64_t', '_handle'), param('int64_t', 'arg_0')])
add_checked_function(mod, 'pyexp_Runtime_ExecWithEngine', retval('int64_t'), [param('int64_t', '_handle'), param('int64_t', 'ctx'), param('int64_t', 'req'), param('int64_t', 'e')])
mod.add_function('pyexp_PyVal_CTor', retval('int64_t'), [])
mod.add_function('pyexp_PyVal_Value_Get', retval('char*'), [param('int64_t', 'handle')])
mod.add_function('pyexp_PyVal_Value_Set', None, [param('int64_t', 'handle'), param('char*', 'val')])
mod.add_function('pyexp_PyVal_Timestamp_Get', retval('int64_t'), [param('int64_t', 'handle')])
mod.add_function('pyexp_PyVal_Timestamp_Set', None, [param('int64_t', 'handle'), param('int64_t', 'val')])
mod.add_function('pyexp_PyVal_Fresh_Get', retval('bool'), [param('int64_t', 'handle')])
mod.add_function('pyexp_PyVal_Fresh_Set', None, [param('int64_t', 'handle'), param('bool', 'val')])
mod.add_function('pyexp_BasicOp_CTor', retval('int64_t'), [])
mod.add_function('pyexp_ExecRequest_CTor', retval('int64_t'), [])
mod.add_function('pyexp_ExecRequest_Headers_Get', retval('int64_t'), [param('int64_t', 'handle')])
mod.add_function('pyexp_ExecRequest_Headers_Set', None, [param('int64_t', 'handle'), param('int64_t', 'val')])
mod.add_function('pyexp_ExecRequest_Payload_Get', retval('int64_t'), [param('int64_t', 'handle')])
mod.add_function('pyexp_ExecRequest_Payload_Set', None, [param('int64_t', 'handle'), param('int64_t', 'val')])
mod.add_function('pyexp_ExecRequest_EntityID_Get', retval('char*'), [param('int64_t', 'handle')])
mod.add_function('pyexp_ExecRequest_EntityID_Set', None, [param('int64_t', 'handle'), param('char*', 'val')])
mod.add_function('pyexp_ExecRequest_Timestamp_Get', retval('int64_t'), [param('int64_t', 'handle')])
mod.add_function('pyexp_ExecRequest_Timestamp_Set', None, [param('int64_t', 'handle'), param('int64_t', 'val')])
mod.add_function('pyexp_ExecRequest_Logger_Get', retval('int64_t'), [param('int64_t', 'handle')])
mod.add_function('pyexp_ExecRequest_Logger_Set', None, [param('int64_t', 'handle'), param('int64_t', 'val')])
mod.add_function('pyexp_ExecResponse_CTor', retval('int64_t'), [])
mod.add_function('pyexp_ExecResponse_Value_Get', retval('int64_t'), [param('int64_t', 'handle')])
mod.add_function('pyexp_ExecResponse_Value_Set', None, [param('int64_t', 'handle'), param('int64_t', 'val')])
mod.add_function('pyexp_ExecResponse_Timestamp_Get', retval('int64_t'), [param('int64_t', 'handle')])
mod.add_function('pyexp_ExecResponse_Timestamp_Set', None, [param('int64_t', 'handle'), param('int64_t', 'val')])
mod.add_function('pyexp_ExecResponse_EntityID_Get', retval('char*'), [param('int64_t', 'handle')])
mod.add_function('pyexp_ExecResponse_EntityID_Set', None, [param('int64_t', 'handle'), param('char*', 'val')])
mod.add_function('pyexp_ExecResponse_Instructions_Get', retval('int64_t'), [param('int64_t', 'handle')])
mod.add_function('pyexp_ExecResponse_Instructions_Set', None, [param('int64_t', 'handle'), param('int64_t', 'val')])
mod.add_function('pyexp_Instruction_CTor', retval('int64_t'), [])
mod.add_function('pyexp_Instruction_Operation_Get', retval('int64_t'), [param('int64_t', 'handle')])
mod.add_function('pyexp_Instruction_Operation_Set', None, [param('int64_t', 'handle'), param('int64_t', 'val')])
mod.add_function('pyexp_Instruction_FQN_Get', retval('char*'), [param('int64_t', 'handle')])
mod.add_function('pyexp_Instruction_FQN_Set', None, [param('int64_t', 'handle'), param('char*', 'val')])
mod.add_function('pyexp_Instruction_EntityID_Get', retval('char*'), [param('int64_t', 'handle')])
mod.add_function('pyexp_Instruction_EntityID_Set', None, [param('int64_t', 'handle'), param('char*', 'val')])
mod.add_function('pyexp_Instruction_Timestamp_Get', retval('int64_t'), [param('int64_t', 'handle')])
mod.add_function('pyexp_Instruction_Timestamp_Set', None, [param('int64_t', 'handle'), param('int64_t', 'val')])
mod.add_function('pyexp_Instruction_Value_Get', retval('int64_t'), [param('int64_t', 'handle')])
mod.add_function('pyexp_Instruction_Value_Set', None, [param('int64_t', 'handle'), param('int64_t', 'val')])
mod.add_function('pyexp_InstructionsBag_CTor', retval('int64_t'), [])
mod.add_function('pyexp_InstructionsBag_Instructions_Get', retval('int64_t'), [param('int64_t', 'handle')])
mod.add_function('pyexp_InstructionsBag_Instructions_Set', None, [param('int64_t', 'handle'), param('int64_t', 'val')])
add_checked_function(mod, 'pyexp_PyExecReq', retval('int64_t'), [param('char*', 'jsonPayload'), param('PyObject*', 'p', transfer_ownership=False)])
add_checked_string_function(mod, 'pyexp_JsonAny', retval('char*'), [param('int64_t', 'a')])
add_checked_function(mod, 'pyexp_New', retval('int64_t'), [param('char*', 'program'), param('char*', 'fqn')])
add_checked_function(mod, 'pyexp_PyTime', retval('int64_t'), [param('char*', 'str'), param('char*', 'layout')])
add_checked_string_function(mod, 'pyexp_PyTimeRFC3339', retval('char*'), [param('int64_t', 't')])

mod.generate(open('pyexp.c', 'w'))
