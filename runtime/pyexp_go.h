...
/* package github.com/natun-ai/sdk/runtime/runtime */
...
extern long long int Slice_pyexp_Instruction_CTor();
extern GoInt Slice_pyexp_Instruction_len(long long int handle);
extern long long int Slice_pyexp_Instruction_elem(long long int handle, GoInt _idx);
extern long long int Slice_pyexp_Instruction_subslice(long long int handle, GoInt _st, GoInt _ed);
extern void Slice_pyexp_Instruction_set(long long int handle, GoInt _idx, long long int _vl);
extern void Slice_pyexp_Instruction_append(long long int handle, long long int _vl);
...
extern long long int pyexp_Runtime_DiscoverDependencies(long long int _handle);
extern long long int pyexp_Runtime_Exec(long long int _handle, long long int arg_0);
extern long long int pyexp_Runtime_ExecWithEngine(long long int _handle, long long int ctx, long long int req, long long int e);

// --- wrapping struct: pyexp.InstructionsBag ---
extern long long int pyexp_InstructionsBag_CTor();
extern long long int pyexp_InstructionsBag_Instructions_Get(long long int handle);
extern void pyexp_InstructionsBag_Instructions_Set(long long int handle, long long int val);

// --- wrapping struct: pyexp.PyVal ---
extern long long int pyexp_PyVal_CTor();
extern char* pyexp_PyVal_Value_Get(long long int handle);
extern void pyexp_PyVal_Value_Set(long long int handle, char* val);
extern long long int pyexp_PyVal_Timestamp_Get(long long int handle);
extern void pyexp_PyVal_Timestamp_Set(long long int handle, long long int val);
extern char pyexp_PyVal_Fresh_Get(long long int handle);
extern void pyexp_PyVal_Fresh_Set(long long int handle, char val);

// --- wrapping struct: pyexp.BasicOp ---
extern long long int pyexp_BasicOp_CTor();

// --- wrapping struct: pyexp.ExecRequest ---
extern long long int pyexp_ExecRequest_CTor();
extern long long int pyexp_ExecRequest_Headers_Get(long long int handle);
extern void pyexp_ExecRequest_Headers_Set(long long int handle, long long int val);
extern long long int pyexp_ExecRequest_Payload_Get(long long int handle);
extern void pyexp_ExecRequest_Payload_Set(long long int handle, long long int val);
extern char* pyexp_ExecRequest_EntityID_Get(long long int handle);
extern void pyexp_ExecRequest_EntityID_Set(long long int handle, char* val);
extern long long int pyexp_ExecRequest_Timestamp_Get(long long int handle);
extern void pyexp_ExecRequest_Timestamp_Set(long long int handle, long long int val);
extern long long int pyexp_ExecRequest_Logger_Get(long long int handle);
extern void pyexp_ExecRequest_Logger_Set(long long int handle, long long int val);

// --- wrapping struct: pyexp.ExecResponse ---
extern long long int pyexp_ExecResponse_CTor();
extern long long int pyexp_ExecResponse_Value_Get(long long int handle);
extern void pyexp_ExecResponse_Value_Set(long long int handle, long long int val);
extern long long int pyexp_ExecResponse_Timestamp_Get(long long int handle);
extern void pyexp_ExecResponse_Timestamp_Set(long long int handle, long long int val);
extern char* pyexp_ExecResponse_EntityID_Get(long long int handle);
extern void pyexp_ExecResponse_EntityID_Set(long long int handle, char* val);
extern long long int pyexp_ExecResponse_Instructions_Get(long long int handle);
extern void pyexp_ExecResponse_Instructions_Set(long long int handle, long long int val);

// --- wrapping struct: pyexp.Instruction ---
extern long long int pyexp_Instruction_CTor();
extern long long int pyexp_Instruction_Operation_Get(long long int handle);
extern void pyexp_Instruction_Operation_Set(long long int handle, long long int val);
extern char* pyexp_Instruction_FQN_Get(long long int handle);
extern void pyexp_Instruction_FQN_Set(long long int handle, char* val);
extern char* pyexp_Instruction_EntityID_Get(long long int handle);
extern void pyexp_Instruction_EntityID_Set(long long int handle, char* val);
extern long long int pyexp_Instruction_Timestamp_Get(long long int handle);
extern void pyexp_Instruction_Timestamp_Set(long long int handle, long long int val);
extern long long int pyexp_Instruction_Value_Get(long long int handle);
extern void pyexp_Instruction_Value_Set(long long int handle, long long int val);
extern long long int pyexp_PyExecReq(char* jsonPayload, PyObject* p);
extern char* pyexp_MarshalExecResponse(long long int resp);
extern long long int pyexp_New(char* program, char* fqn);
extern long long int pyexp_PyTime(char* str, char* layout);
