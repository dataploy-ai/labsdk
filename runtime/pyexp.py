...
# python wrapper for package github.com/natun-ai/natun/pkg/pyexp within overall package pyexp
...
# ---- Functions ---
def MarshalExecResponse(resp):
	"""MarshalExecResponse(object resp) str"""
	return _pyexp.pyexp_MarshalExecResponse(resp.handle)
def New(program, fqn):
